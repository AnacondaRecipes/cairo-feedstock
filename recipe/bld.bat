...
make -f Makefile.win32 CFG=release ^
  ...
  FREETYPE_LIBS=%CYGWIN_PREFIX%/Library/lib/freetype.lib ^
  ...
  CAIRO_LIBS='gdi32.lib msimg32.lib user32.lib %CYGWIN_PREFIX%/Library/lib/libpng.lib %CYGWIN_PREFIX%/Library/lib/freetype.lib %CYGWIN_PREFIX%/Library/lib/zlib.libi'
